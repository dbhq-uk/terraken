...
.exposure { --accent: var(--critical); margin: 0 0 2.25rem; }
.exposed { list-style: none; margin: 0; padding: 0; }
.exposed li {
...
.exposed .looks { display: block; font-size: 0.85rem; color: var(--muted); margin-top: 0.15rem; }
.exposure .advice { margin: 0.8rem 0 0; font-size: 0.9rem; }
