...
# The fixture is chosen to show the two things nothing else in this space
# does: a critical data-loss escalation, and a rename whose moved block is
# missing, with the evidence behind it.
